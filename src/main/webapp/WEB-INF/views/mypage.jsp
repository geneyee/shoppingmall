      ...
      <ul class="nav">
        ...
        <div class="contents1">
            <div class="container" style="width:1000px;">
                <div id="sign-title">
                    <div style="display: inline-block;margin:8px 0px 0px 2px;"> 
                    <div style="display: inline-block;margin-bottom: 5px;vertical-align:bottom;margin-left: 30px;">마이페이지</div>
                </div>
					<div id="information" style="margin-top: 20px;">
						<div id="info-title">정보 확인</div>
						<div id="info-table">
							<table border="0">
								<tr>
									<td><input type="text" id="user_id" name="user_id"
										value="<%=user_id %>" size="65" readonly /></td>
								</tr>
								<tr>
									<td><input type="text" id="name" name="name"
										value="<%=user.getName() %>" size="65" readonly /></td>
								</tr>
								<tr>
									<td><input type="text" name="tel" title="휴대폰 앞자리 선택"
										style="width: 120px; font-size: 13px; padding: 7px 0px; margin: 8px"
										value="<%=user.getTel()%>" readonly /> <font
										style="font-size: 13px;">-</font><input type="text"
										name="tel1" id="tel1" size="15" value="<%=user.getTel1() %>"
										readonly /> <font style="font-size: 13px;">-</font><input
										type="text" name="tel2" id="tel2" size="15"
										value="<%=user.getTel2() %>" readonly /></td>
								</tr>
								<tr>
									<td><input type="text" name="email" type="text"
										class="box" id="email" size="25" value="<%=user.getEmail() %>"
										readonly /><font style="font-size: 13px;">@</font><input
										type="text" name="email1" type="text" class="box" id="email1"
										size="30" value="<%=user.getEmail1() %>" readonly /></td>
								</tr>
								<tr>
									<td>
										...
										value="<%=user.getAddress() %>" name="address" id="addrCode"
										type="text" readonly="readonly" /> <input class="form-control"
										value="<%=user.getAddress1() %>" name="address1" id="addr"
										type="text" size="52" readonly="readonly" /> <input
										class="form-control" value="<%=user.getAddress2() %>"
										name="address2" id="addrDetail" type="text" size="65"
										readonly="readonly" />
									</td>
								</tr>
							</table>
							<input type="button" id="updatebtn" value="수정하기"
								style="font-weight: bold; padding: 3px; background: rgba(43, 47, 58); border: none; color: white; margin-left: 10px; margin-top: 13px; width: 100px; height: 40px;"
								onclick="location.href='infoupdateForm.do'" /> <input
								type="button" id="cancle" value="취소"
								style="font-weight: bold; padding: 3px; background: rgba(43, 47, 58); border: none; color: white; margin-left: 10px; margin-top: 13px; width: 100px; height: 40px"
								onclick="history.back();" /> <input type="button" id="deletebtn"
								value="탈퇴하기"
								style="font-weight: bold; padding: 3px; background: orangered; border: none; color: white; margin-left: 125px; margin-top: 13px; width: 100px; height: 40px"
