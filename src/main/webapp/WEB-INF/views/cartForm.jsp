      ...
      <ul class="nav">
        ...
        <div class="contents1">
             <div class="container" style="width:1000px;">
                ...
                <input type="button" value="선택삭제" id="btn1" style="margin-right:10px;width:75px;height:30px;font-weight: bold;font-size:15px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;"onclick="location.href='deleteCartForm.do'"/>
                <input type="button" value="선택수정" id="btn1" style="margin-right:10px;width:75px;height:30px;font-weight: bold;font-size:15px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;"onclick="location.href='updateCartForm.do'"/>
         ...
         <%--        <%if(bvo.size()==0) {   %>
                	<script>alert("장바구니 비어있습니다");history.back();</script>
                <%} %> --%>
                ...
                <%} %>
                <div id="jang-table3">
                    <div id="font-total" style="float: left;width: 200px;height: 35px;font-size: 30px;font-weight: bolder;padding: 20px 0px 0px 40px;">
                        1.전체 합계
                    </div>
                    <div id="total-box">
                ...
                <input type="submit" value="주문하기>" style="width: 280px;height:90px;background: rgba(43,47,58);border: none;font-size: 25px; color: white;margin: 50px 0px 55px 350px;">
                </form>
                <%} %>
            </div>
        </div>
