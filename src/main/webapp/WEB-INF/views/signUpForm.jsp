...
<!-- </bonobono-fixed> -->
  <link href="<c:url value="/resources/css/signup.css" />" rel="stylesheet"></link>
...
<!-- added css -->
<a href="#" class="go-top" style="z-index:200;">▲</a>
<script>
...
function agree() { 
	...
	var chk = false; for(var i=0 ; i<chkbox.length ; i++) { 
		if(chkbox[i].checked) { chk = true; 
			...
			} if(chk) { alert("환영합니다:-) 메인페이지로 이동합니다."); 
			return window.location="main.do";
...
function openConfirmid(user_id){
	...
	url = "registerCheck.do?user_id=" + user_id;
...
function checkIt(){
	...
	/* if(!user_id || !name || !pwd || !pwd1 || 
			   !tel || !tel1 || !tel2 ||
			   !email || !email1 || !address || !address1 || !address2){
...
function checkemailaddy(){
		if (userinput.email_select.value == '1') {
			userinput.email1.readOnly = false;
			userinput.email1.value = '';
			userinput.email1.focus();
		}
		else {
			userinput.email1.readOnly = true;
			userinput.email1.value = userinput.email_select.value;
		}
	}
</script>
<script>
...
%>
 ...
 <div class="wrap">
      ...
      <ul class="nav">
        ...
        <!-- END Menu -->
        <!--//헤더-->
        <form action="signUp.do" method="post" name="userinput" onsubmit="return checkIt();">
        <div class="contents1">
            <div class="container" style="width:1000px;">
                <div id="sign-title"style="color:black;">가즈아 회원가입</div>
                <div id="information">
                    <div id="info-title"style="font-size:27px;">1. 정보입력</div>
                    <div id="info-table">
                    
                        <table border="0">
                            <tr>
                               <td><input type="text" id="user_id" name="user_id" placeholder="아이디" size="55"/>
                               <button type="button" class="btn btn-default" onclick="openConfirmid(this.form)" style="font-size:13px;font-weight: bold;padding: 3px;background: rgba(114,107,101);color: white;">중복확인</button>
                                <div class="alert alert-warning" id="alert-info">아이디는 4~8자의 영문 대소문자와 숫자로만 입력</div>                          
                            	</td>
                            </tr>
                            <tr>
                               <td><input type="text" id="name" name="name" placeholder="이름" size="55"/></td> 
                            </tr>
                            <tr>
                            ...
                            <tr>
                               ...
                               <input class="form-control" placeholder="도로명 주소" name="address1" id="address1" type="text" size="45" readonly="readonly" />
                               <button type="button" class="btn btn-default" onclick="execPostCode();"style="font-size:13px;font-weight: bold;padding: 3px;background: rgba(114,107,101);color: white;"><i class="fa-search"></i>우편번호 찾기</button><br>
     ...
     <tr>
      <td align="center">
          ...
          <table width="780">
            <tbody><tr>
              <td>
                <div style="margin-top:35px;margin-left:40px;">
                 <font color="rgba(43,47,58)" size="4">01</font> <font size="3">이용약관</font>
                </div>
                <br>
             </td>
           </tr>
           <tr>
             <td align="center">
               <textarea readonly name="tos" rows="12" cols="85" style="resize:none; margin-left:160px;font-size:14px;">제1조(목적)
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                </br><input type="checkbox" name="agree" id="chk1"style="margin-left:600px;"><span style="font-weight: bold;font-size: 14px;">[필수]</span><span style="font-size: 14px;">동의 하신다면 체크해주세요.</span>
              </td>
            </tr>
            <tr>
              <td>
                <div style="margin-top:35px;margin-left:40px;">
                <br>
                 <font color="rgba(43,47,58);" size="4">02</font> <font size="3">개인정보 수집 및 이용에 대한 안내<br></font>
                </div>
                <br>
             </td>
           </tr>
           <tr>
             <td align="center">
               <textarea readonly name="tos" rows="12" cols="85" style="resize:none; margin-left:160px;font-size:14px;">수집하는 개인정보의 항목
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                </br><input type="checkbox" name="agree" id="chk2"style="margin-left:600px;"><span style="font-weight: bold;font-size: 14px;">[필수]</span><span style="font-size: 14px;">동의 하신다면 체크해주세요.</span>
              </td>
            </tr>
          </tbody></table>
      </td>
                    ...
                    <input type="submit" value="회원가입하기" id="submit" disabled = "disabled" style="border:none;width:290px;height:60px;font-weight: bold;padding: 3px;background: rgba(43,47,58);color: white;margin-left:173px;margin-top:60px;"onclick="location.href='javascript:agree()'"/>
                    <input type="reset" value="취소하기" id="btn1" style="border:none;width:290px;height:60px;font-weight: bold;padding: 3px;background: rgba(43,47,58);color: white;margin-left:90px;margin-top:60px;"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--//컨텐츠-->
          <div class="footer" style="background: rgba(249,249,249);font-size:10px;">
           <div class="container" style="font-size:10px;width:1300px;">
            <div id="footer">
                <ul>
