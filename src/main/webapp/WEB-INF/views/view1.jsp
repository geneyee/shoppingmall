...
<body>
	...
	<%
		...
		Board1VO bbs = new Board1DAO().getBoard1(board_ID);
	%>
	...
	<div class="wrap">
      ...
      <ul class="nav">
		...
		<div class="contents1" style="height:700px;"style="background: rgba(249,249,249);">
			<div class="container">
				<div class="container">
					<div class="row">
						<div class="col-lg-10">
					...
					.replaceAll("\n", "<br/>")%></div></td>
										...
										<tr style="background: #2b2f3a; opacity: 0.6;">
											<td><div
											...
											<td><div
													...
													<%=bbs.getBoard_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
					.replaceAll("\n", "<br/>")%></div></td>
										</tr>
									</tbody>
								</table>
								<input type="button" value="목록"
									...
									onclick="location.href='board1.do;'" /> <input type="button"
									value="답변"
									...
									onclick="location.href='refForm.do?board_ID=<%=board_ID%>'" />
								<input type="button" value="수정"
									style="font-weight: bold; padding: 3px; background: #2b2f3a; color: white; margin-left: 10px; margin-top: 10px; width: 90px; height: 30px; border: none;"
									onclick="location.href='updateForm1.do?board_ID=<%=board_ID%>'" />
								<input type="button" value="삭제"
									style="font-weight: bold; padding: 3px; background: #2b2f3a; color: white; margin-left: 365px; margin-top: 10px; width: 90px; height: 30px; border: none;"
									onclick="location.href='delete1.do?board_ID=<%=board_ID%>'" />
							</form>
						</div>
					</div>
				</div>
