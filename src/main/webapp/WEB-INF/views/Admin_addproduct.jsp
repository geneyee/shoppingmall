      ...
      <ul class="nav">
         ...
         <div class="contents1">
            <div class="container">
                  ...
                  <div class="row">
                     <form method="post" action="admin_addProduct.do">
                        <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
                           <tbody>
                                <tr style="background: #2b2f3a;">
                                   <td><div style=" width: 333px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품이름</div></td>
                                   <td><div style=" width: 283px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품옵션</div></td>
                                   <td><div style=" width: 283px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품갯수</div></td>
                                   <td><div style=" width: 284px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품가격</div></td>
                                </tr>
                                    <tr style="background: rgba(249,249,249);">
                                    <td><input type="text" name="pname" style="width: 333px;height: 30px;"></input></td>
                                    <td><input type="text" name="poption" style="width: 283px;height: 30px;"></input></td>
                                    <td><input type="text" name="cnt" style="width: 283px;height: 30px;"></input></td>
                                    <td><input type="text" name="price" style="width: 284px;height: 30px;"></input></td>
                                    </tr>
                           </tbody>
                        </table>
                        <input type="submit" value="추가하기" id="btn1" style="margin-right:10px;border:none;width:215px;height:80px;font-weight: bold;font-size:25px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;'"/>
