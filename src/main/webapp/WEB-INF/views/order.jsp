      ...
      <ul class="nav">
        ...
        <div class="contents1">
             <div class="container" style="width:1000px;">
                ...
                <form action="order.do" role="form" method="post" autocomplete="off">
                    <%for (int i=0;i<bvo.size();i++){ %>
                <div id="jang-table1">
                    <table border="0">
                        <tr>
                            <td>
                               <span style="border: 1px solid black; display: inline-block;width: 110px;height: 120px;"><img src="resources/img/<%=bvo.get(i).getPoption()%>.jpg" width="110" height="120" /></span>
                            </td>    
                            <td>
                            <div style="display:inline-block;width:350px;height:50px;">
                               <%=bvo.get(i).getPname() %>(<%=bvo.get(i).getPoption() %>)
                            </div>
                            </td>
                            <td>
                                <span style="padding-right: 30px;border-right: 1px solid rgba(0,0,0,0.3);margin-left:60px;">
                                    <input type="text" name="cnt" value="<%=bvo.get(i).getCnt() %>" required="true" size="1">
                                </span>
                            </td>
                            <td>
                                <span style="display: inline-block;width: 137px;height: 100%;text-align: center;color: red;font-weight: 500;font-size: 14px;padding-left:5px;">0원<br><br><input type="button" value="쿠폰적용" style="width: 80px;height: 30px; font-size: 14px; background: red;color: white;border: none;"></span>
                            </td>
                            <td>
                           ...
                           %>
                            ...
                            <input type="hidden" name="poption" value="<%=bvo.get(i).getPoption() %>" />
                        </tr>
                    </table>
                </div>
                <%} %>
             ...
             <div class="orderInfo">
                <div id="font-total" style="float: left;width: 200px;height: 35px;font-size: 30px;font-weight: bolder;padding: 50px 0px 0px 80px;">2.주문 확인 </div>
                 <input type="hidden" name="tot" value=<%=tot %> />
                 <div id="total-box">
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">수령인<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="name11" size="40" id="orderRec" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">수령인 연락처<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="phone11" size="40" id="orderPhon" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">주소<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="address11" size="40" id="address" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">이메일<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="email11" size="40" id="address1" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">총금액<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="ltot11" size="40" id="address2" required="required" /></div></div></div>
                </div>
         </div>
         <div style="margin:0px 0px 50px 370px;">
              <input type="submit" value="주문하기>" class="order_btn" style="border:none;width:215px;height:80px;font-weight: bold;font-size:25px;padding: 3px;background: rgba(43,47,58);color: white;margin-right:30px;margin-top:60px;"/>
          </div>
       </form> 
       </div>
        </div>
