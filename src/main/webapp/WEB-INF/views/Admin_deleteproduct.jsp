      ...
      <ul class="nav">
         ...
         <div class="contents1" >
            <div class="container" >
                  ...
                  <div class="row">
                     <form method="post" action="admin_deleteProduct.do">
                                ...
                                <tr style="background: #2b2f3a;">
                                   ...
                                   <%for(ShopVO vo : bvo) {%>
                                    <tr style="background: rgba(249,249,249);">
                                       ...
                                       <td><div style="width: 311px;height: 30px;"><a href="admin_deleteProduct.do?pname=<%=vo.getPname() %>&poption=<%=vo.getPoption() %>"><%=vo.getPname() %></a></div></td>
                        ...
                        <!-- <input type="submit" value="상품삭제" id="btn1" style="margin-right:10px;border:none;width:215px;height:80px;font-weight: bold;font-size:25px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;"/> -->
