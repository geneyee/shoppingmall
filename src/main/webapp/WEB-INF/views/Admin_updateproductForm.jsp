                        ...
                        <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
                           <tbody>
                                <tr style="background: #2b2f3a;">
                                   ...
                                   <td><div style=" width: 300px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품이름</div></td>
                                   <td><div style=" width: 250px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품옵션</div></td>
                                   <td><div style=" width: 250px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품갯수</div></td>
                                   <td><div style=" width: 250px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">상품가격</div></td>
                                </tr>
                                    <tr style="background: rgba(249,249,249);">
                                       <td><div style="width: 100px;height: 30px;"><%=pid2%></div></td>
                                       <td><div style="width: 300px;height: 30px;"><%=pname2 %></div></td>
                                       <td><div style="width: 250px;height: 30px;"><%=poption2%></div></td>
                                       <input type="hidden" name="pname" value=<%=pname2%>></input>
                                       <input type="hidden" name="poption" value=<%=poption2%>></input>
                                       <td><input type="text" name="cnt" style="width: 245px;height: 30px;"></input></td>
                                       <td><input type="text" name="price" style="width: 245px;height: 30px;"></input></td>
                                   </tr>
                           </tbody>
                        </table>
