...
<%
    ...
    <div class="wrap">
      ...
      <ul class="nav">
        ...
        <!--//헤더-->
        <div class="contents1" style="height:700px">
            <div class="container">
               <div id="write-font">
                   답변
               </div>
      ...
      <div class="row">
      <div class="col-lg-10">
         <form method="post" action="refAction.do">
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;  margin-left: 150px; margin-top: 20px;">
               <thead>
                  <tr>
                     <th colspan="2" style="background-color: #2b2f3a;color: white; text-align: center;height: 40px; width: 500px;">답변하기</th>
                  </tr>
               </thead>
               <tbody>
                     <tr>
                  ...
                  <tr>
                 <th><input type="hidden" name="board_ID" maxlength="30" value="<%=board.getBoard_ID()%>" /></th>
                  </tr>
            <tr>
               <th><input type="hidden" name="user_id" maxlength="30" value="<%=user_id%>" /></th>
            </tr>
                  <!-- <tr>
                     <th colspan="2" style="padding-left: 2px;padding-right: 2px; background-color: #2b2f3a;color: white; text-align: center;height: 40px; width: 900px;opacity: 0.6;">
            ...
            <input type="submit" class="btn btn-dark pull-right" value="글쓰기" style="font-size: 16px;font-weight: bold;width: 90px;height: 30px;text-align: center;margin-left: 987px;color: white;background: #2b2f3a;border: none;"/>
         </form>
      </div>
   </div>
   </div>
