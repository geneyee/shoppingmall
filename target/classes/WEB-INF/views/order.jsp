        ...
        <div class="contents1">
             ...
             <div class="orderInfo">
                <div id="font-total" style="float: left;width: 200px;height: 35px;font-size: 30px;font-weight: bolder;padding: 50px 0px 0px 80px;">2.주문 확인 </div>
                 ...
                 <div id="total-box">
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">수령인<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="orderRec" size="45" id="orderRec" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">수령인 연락처<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="orderPhon" size="45" id="orderPhon" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">우편번호<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="address" size="45" id="address" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">1차 주소<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="address1" size="45" id="address1" required="required" /></div></div></div>
                        <div class="inputArea" style="border-bottom: 1px solid rgba(0,0,0,0.4);width: 500px;height: 35px;font-size: 20px;font-weight: bolder;margin-left: 460px; padding: 30px 0px 0px 10px;text-align: left;">2차 주소<div style="both:clear; float:right;"><div style=" display:inline-block;"><input type="text" name="address2" size="45" id="address2" required="required" /></div></div></div>
                </div>
         </div>
