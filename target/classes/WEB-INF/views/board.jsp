      ...
      <ul class="nav">
        ...
        <div class="contents1" style="background: rgba(249,249,249);">
            ...
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;margin-top: 20px;margin-left: 100px;width:85%;">
               ...
               <td><a href="view.do?board_ID=<%=list.get(i).getBoard_ID()%>"><%=list.get(i).getBoard_Title()%></a></td>
            ...
            <input type="button"value="글쓰기" onClick="location.href='boardwrite.do'"style="font-size: 16px;font-weight: bold;width: 90px;height: 30px;text-align: center;margin:0px 0px 40px 1055px;color: white;background: #2b2f3a;border: none;"/>
              <ul class="pagination" style="margin: 0px 500px;">
               ...
               if(startPage != 1){
               %>
                     <li><a href ="board.do?pageNumber=<%= startPage -1 %>"><span class="glyphicon glyphicon-chevron-left"></span></a></li>
                    <%
               } else {
                    %>
                ...
                for(int i = startPage; i<pageNumber; i++){
                     %>
                       <li><a href ="board.do?pageNumber=<%= i %>"><%=i %></a></li>
                     <%
                     }
                     %>  
                     <li class="active"><a href ="board.do?pageNumber=<%= pageNumber %>"><%= pageNumber %></a></li>
                     <%
                     ...
                     %>
                     <li><a href ="board.do?pageNumber=<%= startPage + 10 %>"><span class="glyphicon glyphicon-chevron-right"></span></a></li>    
                     <%
                     } else {
                     %>
