...
%>
  <div class="wrap">
   ...
   <script src="resources/js/jquery.sumogallery.js"></script>
      ...
      <tr>
         ...
         <ul class="info_lefttitle list__infomation"style="font-size:13px;">
            ...
            <dl class="list__smile-reward">
               ...
               <dd class="list__smile-reward--data"style="font-size:13px;">스마일카드로 결제 시 전월실적, 적립한도 없이 쓸 때마다 최대 2% 적립됨. <a  class="link__more" target="_blank" title="새 창 열기" onclick="pvprofiler.sendEvt('click', '100002173', 'link');" data-montelena-acode="100002173"></a>
            </dl><br>
            <ul class="info_lefttitle list__infomation"style="font-size:13px;">
               <li class="list-item">
                  <strong class="text__title">적립한도</strong>
      ...
      <div style="border-top:1px solid rgba(100,100,100,0.2);border-bottom:1px solid rgba(100,100,100,0.2); width:450px; height:35px; padding-top:10px;padding-bottom:10px;">
      원산지 - 국내산
      </div>
      <div class="plcc_banner">
                  <a  class="btn_banner" onclick="pvprofiler.sendEvt('click', '100001140', 'link');" data-montelena-acode="100001140" target="_blank">
                     <img src="resources/img/ssss.png" alt="스마일카드" 3만원="" 청구할인=""style="width:450px;height:70px;">
                  </a>
               </div><br><br>
      옵션선택<br>
