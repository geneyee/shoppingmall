...
<link href="https://fonts.googleapis.com/css?family=Varela+Round&display=swap" rel="stylesheet">
  <link href="<c:url value="/resources/css/board-view.css" />" rel="stylesheet">
...
<%
		...
		Board2VO bbs = new Board2DAO().getBoard(board_ID);
    ...
    <div class="wrap">
      ...
      <div class="col-lg-10">
         <form method="post" action="writeAction2.jsp">
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;  margin-left: 195px; margin-top: 20px;">
               <thead>
                  <tr>
                     <th colspan="2" style="background-color: #2b2f3a;color: white; text-align: center;height: 45px; width: 500px;">게시판 글보기</th>
                  </tr>
               </thead>
               <tbody>
                    <tr style="background: #2b2f3a;">
                       <td><div style=" width: 45px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">글 제목</div></td>
                       <td><div style="border: 1px solid black;width: 700px;height: 40px; background: white;margin: 4px 3px;"><%= bbs.getBoard_Title().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br/>") %></div></td>
                    </tr>
                    <tr style="background: #2b2f3a;">
                       <td><div style=" width: 45px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">작성자</div></td>
                       <td><div style="border: 1px solid black;width: 700px;height: 40px;margin: 4px 3px;background: white;"><%= bbs.getUser_id() %> </div></td>
                    </tr>
                    <tr style="background: #2b2f3a;">
                       <td><div style=" width: 45px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">작성일</div></td>
                       <td><div style="border: 1px solid black;width: 700px;height: 40px;margin: 4px 3px;background: white;"><%= bbs.getBoard_Date()%></div></td>
                    </tr>
                    <tr style="background: #2b2f3a;">
                       <td><div style=" width: 45px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">내용</div></td>
                       <td><div style="border: 1px solid black;width: 700px;height: 380px;background: white;margin: 5px 3px;">
                       
                       <%= bbs.getBoard_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br/>") %></div></td>
                    </tr>
               </tbody>
            </table>   
            <input type="button" value="목록" style="font-weight: bold;padding: 3px;background: #2b2f3a;color: white;margin-left: 198px;margin-top: 10px; width: 90px;height: 30px;border: none;"onclick="location.href='board2.do;'">
            <input type="button" value="수정하기" style="font-weight: bold;padding: 3px;background: #2b2f3a;color: white;margin-left: 10px;margin-top: 10px; width: 90px;height: 30px;border: none;"onclick="location.href='updateForm2.do?board_ID=<%= board_ID %>'">
            <input type="button" value="삭제" style="font-weight: bold;padding: 3px;background: #2b2f3a;color: white;margin-left: 468px;margin-top: 10px; width: 90px;height: 30px;border: none;"onclick="location.href='delete2.do?board_ID=<%= board_ID %>'">
