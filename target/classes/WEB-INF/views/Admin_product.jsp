            ...
            <div class="container">
                  ...
                  <div class="row">
                     <form method="post" action="writeAction.jsp">
                                ...
                                <tr style="background: #2b2f3a;">
                                   ...
                                   <%for(ShopVO vo : bvo) {%>
                                    <tr style="background: rgba(249,249,249);">
                                       ...
                                       <td><div style="width: 311px;height: 30px;"><%=vo.getPname() %></div></td>
                        ...
                        <input type="button" value="상품추가" id="btn1" style="margin-right:10px;border:none;width:215px;height:80px;font-weight: bold;font-size:25px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;"onclick="location.href='addProductForm.do'"/>
                        <input type="button" value="상품수정" id="btn2" style="margin-right:10px;border:none;width:215px;height:80px;font-weight: bold;font-size:25px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;"onclick="location.href='updateProductForm.do'"/>
                     	<input type="button" value="상품삭제" id="btn1" style="margin-right:10px;border:none;width:215px;height:80px;font-weight: bold;font-size:25px;padding: 3px;background: rgba(214,207,201);color: black;margin-top:30px;"onclick="location.href='deleteProductForm.do'"/>
