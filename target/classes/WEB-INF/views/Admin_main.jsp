  ...
  <div class="wrap">
      ...
      <ul class="nav">
         ...
         <div class="contents1">
            ...
            <div id="product-upload" style="margin-top:150px; margin-bottom:150px;" onclick="location.href='Admin_product.do'">
            </div>
            <div id="member-magement" style="margin-top:150px; margin-bottom:150px;" onclick="location.href='Admin_member.do'">
            </div>
            </div>
                    <br><br><br>
        </div>
