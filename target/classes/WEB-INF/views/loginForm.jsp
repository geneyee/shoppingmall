               ...
               <div id="login-cont">
                  <div id="login-box">
                    <form action="login.do" method="post" id="loginForm"
                        ...
                        </table><a href="https://kauth.kakao.com/oauth/authorize?client_id=7acbea97dbdc9d91c13e7c3e7cf49768&redirect_uri=http://localhost/controller/kakaologin.do&response_type=code">
