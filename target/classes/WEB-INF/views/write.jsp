...
<link href="<c:url value="/resources/css/fixed.css" />" rel="stylesheet">
   <link href="<c:url value="/resources/css/category.css" />"
      ...
      <link href="<c:url value="/resources/css/main.css" />"
         ...
         <link href="<c:url value="/resources/css/board-write.css" />"
            rel="stylesheet">
            <!-- added css -->
</head>
<body>
                              ...
                              <tr>
                                 <th colspan="2"
                                    ...
                                    <textarea class="form-control" placeholder="글 내용"
                                       name="board_Content" maxlength="2048"
                                       style="height: 380px; width: 900px; padding: 5px; margin: 5px 0px; opacity:"></textarea>
                              </tr>
                              <tr>
                                 <th colspan="2"
                                    style="padding-left: 2px; padding-right: 2px; background-color: #2b2f3a; color: white; text-align: center; height: 40px; width: 900px;">
                                    <input type="file" class="form-control" placeholder="이미지첨부"
                                    name="board_file" maxlength="50"
