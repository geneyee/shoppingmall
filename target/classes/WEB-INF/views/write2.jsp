...
<%
   ...
   <div class="wrap">
      ...
      <ul class="nav">
        ...
        <!-- END Menu -->
        <!--//헤더-->
       <div class="contents1" style="height: 700px;background: rgba(249,249,249);">
            <div class="container">
               <div id="write-font">
                   글쓰기
               </div>
      ...
      <div class="row">
      <div class="col-lg-10">
         <form method="post" action="writeAction2.do">
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;  margin-left: 150px; margin-top: 20px;">
               <thead>
                  <tr>
                     <th colspan="2" style="background-color: #2b2f3a;color: white; text-align: center;height: 40px; width: 500px;">게시판 글쓰기 양식</th>
                  </tr>
               </thead>
               <tbody>
                     <tr>
                     <th colspan="2" style="padding-left: 5px;padding-right: 5px;padding-bottom: 3px;padding-top: 3px; background-color: #2b2f3a;color: white; text-align: center;height: 40px; width: 900px;"><input type="text" class="form-control" placeholder="글 제목" name="board_Title" maxlength="50"  style="width: inherit;height: 20px;padding: 5px;"/></th>
                  </tr>
                  <tr>
                     <th colspan="2" style="padding-left: 2px;padding-right: 2px; background-color: #2b2f3a;color: white; text-align: center;height: 40px; width: 900px;">
                     <textarea class="form-control" placeholder="글 내용" name="board_Content" maxlength="2048" style="height: 380px;width: 900px; padding: 5px;margin: 5px 0px;"></textarea>
                  </tr>
                <!--   <tr>
                     <th colspan="2" style="padding-left: 2px;padding-right: 2px; background-color: #2b2f3a;color: white; text-align: center;height: 40px; width: 900px;opacity: 0.6;">
                         <input type="file" class="form-control" placeholder="이미지첨부" name="board_file" maxlength="50" style="float: left; margin-left: 4px;"/>
                         
                         </th>
                  </tr> -->
               </tbody>
            </table>   
            <input type="submit" class="btn btn-dark pull-right" value="글쓰기" style="font-size: 16px;font-weight: bold;width: 90px;height: 30px;text-align: center;margin-left: 987px;color: white;background: #2b2f3a;border: none;" onclick=""/>
         </form>
      </div>
   </div>
   </div>
