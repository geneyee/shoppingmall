 ...
 <div class="wrap">
      ...
      <ul class="nav">
        ...
        <div class="contents1" style="background: rgba(249,249,249);">
            ...
            <input type="button"value="글쓰기" onClick="location.href='board2write.do'"style="font-size: 16px;font-weight: bold;width: 90px;height: 30px;text-align: center;margin:0px 0px 40px 1055px;color: white;background: #2b2f3a;border: none;"/>
