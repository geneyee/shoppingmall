					...
					.replaceAll("\n", "<br/>")%></div></td>
										...
										<tr style="background: #2b2f3a;">
											...
											<td><div
													...
													<img src="resources/img/<%=bbs.getBoard_file()%>" /><%=bbs.getBoard_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
					.replaceAll("\n", "<br/>")%>
												</div></td>
										</tr>
									</tbody>
								...
								<input type="button" value="목록"
									...
									onclick="location.href='updateForm.do?board_ID=1'"> <input
										...
										onclick="location.href='delete.do?board_ID=1'">
							</form>
							<%
							...
							<div id="reply">
								<ol class="replylist"
									...
									%>
									작성자 :
									<%=commentlist.get(i).getComment_id()%>&nbsp;&nbsp; 작성일 :
