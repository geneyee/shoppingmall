...
<% 
	...
	ArrayList<UserVO> userArray = userDAO.getAllInfo(vo);
         ...
         <div class="contents1">
            <div class="container">
                  <div class="container">
                    ...
                    <div style="display: inline-block;margin-bottom: 30px;vertical-align:middle;">회원 전체목록</div>
                	</div>
				      <div class="row">
				            ...
				            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
				               <tbody>
				                    <tr style="background: #2b2f3a;">
				                       <td><div style=" width: 100px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">아이디</div></td>
				                       <td><div style=" width: 100px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">이름</div></td>
				                       <td><div style=" width: 250px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">전화번호</div></td>
				                       <td><div style=" width: 250px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">이메일</div></td>
				                       <td><div style=" width: 250px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;주소</div></td>
				                       <td><div style=" width: 95px;height: 30px;text-align: center;color: white;font-weight: bold;padding-top: 10px;">포인트</div></td>
				                    </tr>
				                    	<%for(UserVO userinfo : userArray) {%>
				                    	 <tr style="background: rgba(249,249,249);">
				                    	 	<td><div style="width: 100px;height: 30px; "><%=userinfo.getUser_id()%></div></td>
				                    	 	<td><div style="width: 100px;height: 30px;"><%=userinfo.getName() %></div></td>
				                    	 	<td><div style="width: 250px;height: 30px;"><%=userinfo.getTel() %>-<%=userinfo.getTel1() %>-<%=userinfo.getTel2() %></div></td>
				                    	 	<td><div style="width: 250px;height: 30px;"><%=userinfo.getEmail() %>@<%=userinfo.getEmail1() %></div></td>
				                    	 	<td><div style="width: 400px;height: 30px;"><%=userinfo.getAddress1()%><%=userinfo.getAddress2()%></div></td>
				                    	 	<td><div style="width: 95px;height: 30px;"><%=userinfo.getUser_point() %></div></td>
				                    	 <%} %>
				                    	 </tr>
				               </tbody>
				            </table>
